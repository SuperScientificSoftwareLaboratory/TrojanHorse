...
void pangulu_numeric_batch_postproc(
...
//     pangulu_int64_t ntask_no_ssssm_remote = 0;
//     for (pangulu_int64_t i = 0; i < ntask_no_ssssm; i++)
//     {
//         if (!((tasks[i].row % p == rank / q) && (tasks[i].col % q == rank % q)))
//         {
//             // (*aggregate_batch_tileid)[ntask_no_ssssm_remote] = tasks[i].opdst;
//             if (i != ntask_no_ssssm_remote)
//             {
//                 pangulu_task_t tmp = tasks[i];
//                 tasks[i] = tasks[ntask_no_ssssm_remote];
//                 tasks[ntask_no_ssssm_remote] = tmp;
//             }
//             ntask_no_ssssm_remote++;
//         }
//     }

//     for (pangulu_int64_t i = 0; i < ntask_no_ssssm; i++){
//         (*aggregate_batch_tileid)[i] = tasks[i].opdst;
//     }

//     pangulu_int64_t ntask_no_ssssm_local = ntask_no_ssssm - ntask_no_ssssm_remote;
...
//     pangulu_aggregate_task_compute_multi_tile(ntask_no_ssssm_remote, *aggregate_batch_tileid, pangulu_execute_aggregated_ssssm, &param);
//     pangulu_hybrid_batched_interface(nb, ntask_no_ssssm_remote, tasks);
//     pangulu_numeric_batch_postproc(ntask_no_ssssm_remote, tasks, common, block_common, block_smatrix);

//     pangulu_aggregate_task_compute_multi_tile(ntask_no_ssssm_local, (*aggregate_batch_tileid) + ntask_no_ssssm_remote, pangulu_execute_aggregated_ssssm, &param);
//     pangulu_hybrid_batched_interface(nb, ntask_no_ssssm_local, tasks + ntask_no_ssssm_remote);
//     pangulu_numeric_batch_postproc(ntask - ntask_no_ssssm_remote, tasks + ntask_no_ssssm_remote, common, block_common, block_smatrix);
// }
    ...
    pangulu_block_smatrix *block_smatrix)
{
    ...
    pangulu_numeric_batch_postproc(ntask, tasks, common, block_common, block_smatrix);
}
