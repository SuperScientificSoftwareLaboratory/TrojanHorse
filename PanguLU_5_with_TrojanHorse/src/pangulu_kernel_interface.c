    ...
    int tid)
{
    ...
    //     for(int idx = upper_diag->columnpointer[col]; idx < upper_diag->columnpointer[col+1]; idx++){
    //         printf("(%d, %.0lf) ", upper_diag->rowindex[idx], upper_diag->value[idx]);
    //     }
    //     printf("\n");
    // }
    ...
    // printf("lower_diag : \n");
    // for(int col = 0; col < nb; col++){
    //     for(int idx = lower_diag->columnpointer[col]; idx < lower_diag->columnpointer[col+1]; idx++){
    //         printf("(%d, %.0lf) ", lower_diag->rowindex[idx], lower_diag->value[idx]);
    //     }
    //     printf("\n");
    // }
    ...
    pangulu_task_t *tasks)
{
    ...
    //         }else{
    //             for(int col = 0; col < nb; col++){
    //                 for(int idx = tasks[i].opdst->columnpointer[col]; idx < tasks[i].opdst->columnpointer[col+1]; idx++){
    //                     printf("(%d, %.0lf) ", tasks[i].opdst->rowindex[idx], tasks[i].opdst->value[idx]);
    //                 }
    //                 printf("\n");
    //             }
    //         }
