...
printf("[Yida] %s:%d kk1=%d kk2=%d\n", __FILE__, __LINE__, kk1, kk2);
...
printf("[Yida] %s:%d kk0=%d\n", __FILE__, __LINE__, kk0);

                    PDGSTRF2(options, kk0, kk, thresh, Glu_persist,
                             grid, Llu, U_diag_blk_send_req, tag_ub, stat, info); // (Yida) : GETRF
...
printf("[Yida] %s:%d\n", __FILE__, __LINE__);
                        ...
                        //     double* uval = Llu->Unzval_br_ptr[LBi(kk, grid)];
...
/* #pragma omp parallel */ /* Sherry -- parallel done inside pdgstrs2 */
                        ...
                        // {
                        //     printf("[Yida] Golden : \n");
                        //     int local_kk = LBi(kk, grid);
                        //     double* uval = Llu->Unzval_br_ptr[local_kk];
                        //     printf("kk=%d local_kk=%d\n", kk, local_kk);
                        //     for(int lyd_i = 0; lyd_i < 60; lyd_i++){
                        //         printf("[%d]=%le\n", lyd_i, uval[lyd_i]);
                        //     }
                        // }
